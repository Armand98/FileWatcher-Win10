...
namespace FileWatcher
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private string reverseDate(string date)
        {
            ...
            reversedString = date.Substring(6, 4) + "/" + date.Substring(3, 2) + "/" + date.Substring(0, 2);
        ...
        {
            string fromDate = reverseDate(FromDatePickerBox.SelectedDate.Value.ToShortDateString());
            string toDate = reverseDate(ToDatePickerBox.SelectedDate.Value.AddDays(1).ToShortDateString());
